  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="lead-form">
      <div className="lead-form__group">
        ...
        {errors.first_name && <span className="lead-form__err">{errors.first_name.message}</span>}
      </div>
      ...
      <div className="lead-form__group">
        ...
        {errors.phone && <span className="lead-form__err">{errors.phone.message}</span>}
      </div>

      <div className="lead-form__group">
        <input placeholder="Service details" {...register("service_details")} />
        {errors.service_details && <span className="lead-form__err">{errors.service_details.message}</span>}
      </div>

      <div className="lead-form__group">
        <select defaultValue="" {...register("home_size")}>
          <option value="" disabled>Home Sq. Ft.</option>
          <option value="900-1500">900 - 1500</option>
          <option value="1500-2500">1500 - 2500</option>
          <option value="2500-3500">2500 - 3500</option>
        </select>
        {errors.home_size && <span className="lead-form__err">{errors.home_size.message}</span>}
      </div>
